...
session_start();
$abon = isset($_SESSION['promotion']) ? unserialize($_SESSION['promotion']) : new Promotion();
?>
        ...
        <nav>
            ...
            <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="view/ajouterEvenement.php">Liste des abonnements</a></li>
                        <li><a href="page-event-single.html">Single</a></li>
                    </ul>
                </li>
                <li>
...
<div id="page" class="stylehome1 h0">
    <div class="mobile-menu">
        <div class="header stylehome1">
            <div class="main_logo_home2">
                <img class="nav_logo_img img-fluid float-left mt20" src="../libs/images/header-logo.png" alt="header-logo.png">
                <span>zeryeb</span>
            </div>
    ...
    <nav id="menu" class="stylehome1">
        <ul>
            ...
            <li><span>Abonnements</span>
                <ul>
                    <li><a href="page-event.html">liste des abonnements</a></li>
                    <li><a href="page-event-single.html">Single</a></li>
                </ul>
            </li>
            <li><span>Pages</span>
            ...
            <div class="col-lg-12">
                <div class="main-banner-wrapper">
                    <div class="banner-style-one owl-theme owl-carousel">
                        <div class="slide slide-one" style="background-image: url(libs/images/home/1.jpg); height: 95vh ;">
                            <div class="container">
                        ...
                        <div class="slide slide-one" style="background-image: url(libs/images/home/3.jpg);height: 95vh;">
                            <div class="container">
                                <div class="row home-content">
                                    <div class="col-lg-12 text-center p0">
                        ...
                        <div class="slide slide-one" style="background-image: url(libs/images/home/2.jpg);height: 95vh;">
                            <div class="container">
                                <div class="row home-content">
                                    <div class="col-lg-12 text-center p0">
                    ...
                    <div class="carousel-btn-block banner-carousel-btn">
                        ...
                        <span class="carousel-btn right-btn"><span class="right">SUI<br>VANT</span> <i class="flaticon-right-arrow-1 right"></i></span>
                    </div>
                </div>
            </div>
        </div>
...
<form action="../indexPromotion.php?act=update" method="post">
    <div>
        <label>Nom</label>
    ...
    <div>
        ...
        <input type="text" name="pourcentage" value="<?php echo $abon->getPourcentage(); ?> ">
    </div>
    <div>
<!--        <input value='2004-02-12' type='date'>-->
        <label>Date</label>
<!--        "--><?php //var_dump(($_SESSION['date'])); ?><!-- ">-->
        <input type="date" name="dateProm" value="<?php echo date('Y-m-dY',strtotime(($event->getDateProm()))); ?> ">
    </div>
    <input type="hidden" name="idProm" value="<?php echo  $_SESSION['idProm']; ?>"/>

    <input type="submit" name="updatebtn" value="Submit">
    <a href="../indexPromotion.php">Cancel</a>
</form>
