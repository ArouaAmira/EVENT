        ...
        <nav>
            ...
            <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="view/ajouterEvenement.php">Event List</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="mouse_scroll">
                    ...
                    <form action="../indexPromotion.php?act=add" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <input name="pourcentage" type="text">
                        </div>
                        <div class="form-group">
                            <label>Date </label>
                            <br>
                            <input name="dateProm" type="date">
                        </div>
<!--                        <div class="form-group">-->
<!--                            <label>Adresse </label>-->
